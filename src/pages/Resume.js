  ...
  return (
    <div className='bg-gradient-to-r from-[#793FDF] to-[#7091F5] select-none h-screen flex item-strech space-x-7 '>
      ...
      <div className='place-content-center pt-64'>
        <a alt='' href='https://drive.google.com/file/d/14uMrcWh6-q9l4oLHL7BSOEXmzvB8KrW6/view' className='class="mb-2 flex bg-white/20 border border-white backdrop-blur-md  rounded justify-center  px-6 py-2.5 w-64 h-20  text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" className='w-12 h-12 mr-5' stroke="currentColor" >
